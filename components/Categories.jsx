    ...
    return (
        <div className='container flex flex-col items-center mt-[100px]'>
            ...
            <div className='grid grid-cols-4 gap-[40px] w-full'>
                {Object.keys(categories).map((e,i)=><Link href={"/"+e} key={i} className='flex items-center gap-[12px] bg-white flex-col rounded-[40px] p-[40px] shadow-[2px_10px_30px_#00000013]'>
